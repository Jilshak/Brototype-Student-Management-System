                    ...
                    <ul class="space-y-2 ms-5 mt-5 text-lg">
                        ...
                        </li>
                        {
                            decode.is_superuser ?
                                <li>
                                    <Link to='/dashboard'>
                                        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className='' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-collection" viewBox="0 0 16 16"> 
                        ...
                        }
                        {
                            decode.is_superuser ?
                                <li>
                                    <Link to='/authorize'>
                                        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd" d="M15.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L12.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z" />
                                                <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" /> </svg>
                                            <span class="ml-3 ">Authorize Users</span>
                                        </a>
                                    </Link>
                                </li> : null
                        }
                                ...
                                <li>
                                    <Link to='/schedule_time'>
                                        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            ...
                                            <span class="flex-1 ml-3 whitespace-nowrap">Schedule Time</span>
                                        </a>
                                    </Link>
                                </li> : null
                        }
                                ...
                                <li>
                                    <Link to='/assign_time'>
                                        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            ...
                                            <span class="flex-1 ml-3 whitespace-nowrap">Assign My Time</span>
                                        </a>
                                    </Link>
                                </li> : null
                        }
...

                        {
                            decode.is_user && !decode.is_superuser && !decode.is_reviewer && !decode.is_advisor && decode.authenticated ?
                                <li>
                                    <Link to='/weeks'>
                                        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white  dark:hover:bg-gray-700 group">
                                            ...
                                            <span class="flex-1 ml-3 whitespace-nowrap">Weeks</span>
                        ...
                        <li>
                            <Link to='/notification'>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    {
                                        decode.is_superuser ? <span class="flex-1 ml-3 whitespace-nowrap">Send Notifications</span> : <span class="flex-1 ml-3 whitespace-nowrap">Notifications</span>
                                    }
                                    {!decode.is_superuser ? <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{!decode.is_superuser ? user.sidebar.notification_count : null}</span> : null}
                                </a>
                            </Link>
                        </li>
